...
def main():
    ...
    shared_memory_manager_dict = shared_memory_manager.dict()
    shared_memory_manager_dict["data_worker_running"] = False
    shared_memory_manager_dict["service_reconfiguring"] = False
    shared_memory_manager_dict["config_timestamp"] = -1

    log.info("service initiated")
    notifierService = Notifier()
    notifierService.shared_memory_manager_dict = shared_memory_manager_dict
